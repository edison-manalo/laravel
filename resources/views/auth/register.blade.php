        ...
        <div class="border-b border-white/10 pb-12">
            <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <x-form-field>
                    ...
                    <x-form-input type="text" id="first_name" name="first_name" value="{{ old('first_name') }}"></x-form-input>
                ...
                <x-form-field class="row-start-2">
                    ...
                    <x-form-input type="text" id="last_name" name="last_name" value="{{ old('last_name') }}"></x-form-input>
                ...
                <x-form-field class="row-start-5">
                    ...
                    <x-form-input type="password" id="password_confirmation" name="password_confirmation"></x-form-input>
